...
async def predict_segmentation(
    ...
    padding: int = Form(0, description="Mask padding in pixels"),
):
    """
    ...
    **Parameters:**
    ...
    - **padding**: Mask padding in pixels (0 = no padding)
    ...
    try:
        ...
        if bboxes:
            ...
            mask = predict_mask_from_bboxes(
                image_bytes, bboxes=bbox_list, model_name=model, padding=padding
            )
...
async def crop_to_selection(
    ...
    padding: Optional[int] = Form(0, description="Padding in pixels"),
    ...
    **Parameters:**
    ...
    - **padding**: Padding in pixels around mask (default: 0)
